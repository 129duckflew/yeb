...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES (1, '系统管理员', '13812361398', '71937538', '香港特别行政区强县长寿柳州路p座123', 1, 'admin', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://cdn.jsdelivr.net/gh/129duckflew/GitHubImages/img/%E5%90%91%E6%97%A5%E8%91%B5.png', NULL);
INSERT INTO `t_admin` VALUES (2, '李亮', '18875971675', '41413109', '河北省秀荣市萧山长沙街p座 737268', 1, 'ducflew', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://cdn.jsdelivr.net/gh/129duckflew/GitHubImages/img/%E7%AA%9D%E7%93%9C.png', NULL);
INSERT INTO `t_admin` VALUES (3, '兰翔', '14588110811', '50603155', '山东省凤英县长寿银川街l座', 1, 'naqiao', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://cdn.jsdelivr.net/gh/129duckflew/GitHubImages/img/%E5%90%91%E6%97%A5%E8%91%B5.png', NULL);
INSERT INTO `t_admin` VALUES (4, '黄荣华', '15761248727', '25546253', '宁夏回族自治区帆市翔安昆明路b座 672985', 1, 'leisu', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://cdn.jsdelivr.net/gh/129duckflew/GitHubImages/img/%E5%A5%A5%E7%89%B9%E6%9B%BC.jpg', NULL);
INSERT INTO `t_admin` VALUES (5, '何美伦', '18030710396', '27523842', '宁夏回族自治区秀兰县涪城邯郸路t座 618651', 1, 'hanli', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://cdn.jsdelivr.net/gh/129duckflew/GitHubImages/img/%E5%A5%A5%E7%89%B9%E6%9B%BC.jpg', NULL);
...
INSERT INTO `t_admin_role` VALUES (69, 5, 4);
INSERT INTO `t_admin_role` VALUES (70, 5, 3);
INSERT INTO `t_admin_role` VALUES (71, 5, 2);
INSERT INTO `t_admin_role` VALUES (72, 5, 5);
...
-- ----------------------------
INSERT INTO `t_employee` VALUES (1, '韦梅', '女', '1999-11-20', '341502198810196427', '未婚', 1, '英市', 11, 'xia53@gangjing.cn', '15567487644', '贵州省洁市清城汕尾街d座 502246', 7, 3, 3, '劳动合同', '博士', '电子工程', '中国科学技术大学', '2018-10-16', '在职', '00000001', 9.31, '2018-08-29', NULL, '2017-09-03', '2019-08-26', NULL, 2);
...
CREATE TABLE `t_employee_train`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `finish` tinyint(1) NULL DEFAULT NULL COMMENT '是否完成',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `eid`(`eid`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_employee_train` VALUES (1, 1, '2021-09-22', '培训内容', '备注', 1);
INSERT INTO `t_employee_train` VALUES (2, 1, '2001-01-11', 'asdas', 'dasd', 1);
INSERT INTO `t_employee_train` VALUES (3, 1, '2021-08-31', 'dasd', 'asdas', 1);
INSERT INTO `t_employee_train` VALUES (4, 1, '2021-08-31', 'dasd', 'asdas', 0);
...
INSERT INTO `t_menu_role` VALUES (779, 7, 6);
INSERT INTO `t_menu_role` VALUES (780, 9, 6);
INSERT INTO `t_menu_role` VALUES (781, 10, 6);
INSERT INTO `t_menu_role` VALUES (782, 11, 6);
INSERT INTO `t_menu_role` VALUES (783, 13, 6);
INSERT INTO `t_menu_role` VALUES (784, 14, 6);
INSERT INTO `t_menu_role` VALUES (785, 15, 6);
INSERT INTO `t_menu_role` VALUES (786, 23, 6);
INSERT INTO `t_menu_role` VALUES (787, 24, 6);
INSERT INTO `t_menu_role` VALUES (788, 26, 6);
